...
export const API_PROVIDER_PRESETS: ApiProviderPreset[] = [
  {
    ...
    notes: 'OpenAI GPT-5.5 (2026-04-23, API rollout in progress) + GPT-5.5 Pro on top of the stable 5.4 family. Default stays at 5.4 until 5.5 API is fully GA — switch in the dropdown to use 5.5. GPT-4 class models are retired.',
