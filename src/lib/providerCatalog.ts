...
export const SPEECH_OUTPUT_PROVIDERS: SpeechOutputProviderEntry[] = [
  ...
  {
    id: 'voxtral-local',
    label: 'provider.tts.voxtral-local.label',
    baseUrl: 'http://127.0.0.1:7860/v1',
    defaultModel: 'voxtral-tts',
    defaultVoice: 'default',
    notes: 'provider.tts.voxtral-local.notes',
    protocol: 'openai-compatible',
    kind: 'local',
    hidden: false,
    supportsStreaming: true,
    ...
    styleOptions: OPENAI_TTS_STYLE_OPTIONS,
    modelOptions: [
      { value: 'voxtral-tts', label: 'provider.tts.voxtral-local.model.voxtral-tts.label' },
    ],
    fallbackVoiceOptions: [],
    adjustmentSupport: { rate: false, pitch: false, volume: false, note: 'provider.tts.voxtral-local.adjustment.note' },
  },
  {
    id: 'kyutai-local',
    label: 'provider.tts.kyutai-local.label',
    baseUrl: 'http://127.0.0.1:8010/v1',
    defaultModel: 'pocket-tts',
    defaultVoice: 'default',
    notes: 'provider.tts.kyutai-local.notes',
    protocol: 'openai-compatible',
    kind: 'local',
    hidden: false,
    supportsStreaming: true,
    ...
    styleOptions: OPENAI_TTS_STYLE_OPTIONS,
    modelOptions: [
      { value: 'pocket-tts', label: 'provider.tts.kyutai-local.model.pocket-tts.label' },
    ],
    fallbackVoiceOptions: [],
    adjustmentSupport: { rate: false, pitch: false, volume: false, note: 'provider.tts.kyutai-local.adjustment.note' },
  },
  {
    id: 'omnivoice-tts',
