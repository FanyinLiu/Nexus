...
export const API_PROVIDER_PRESETS: ApiProviderPreset[] = [
  ...
  },
  {
    ...
    notes: 'MiniMax China Token Plan subscription endpoint. Highspeed is only available on Plus-Highspeed and above.',
    protocol: 'anthropic',
    requiresApiKey: true,
  },
  {
    ...
    notes: 'MiniMax global Token Plan subscription endpoint. Highspeed is only available on Plus-Highspeed and above.',
    protocol: 'anthropic',
    requiresApiKey: true,
  },
  {
