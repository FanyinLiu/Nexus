...
export const SETTINGS_STYLE_BUNDLES = [
  {
    id: 'foundation',
    layer: 'A',
    module: 'src/app/settingsStylesFoundation.ts',
  ...
  },
  {
    id: 'theme',
    layer: 'B',
    module: 'src/app/settingsStylesTheme.ts',
  ...
  },
  {
    id: 'surface',
    layer: 'C',
    module: 'src/app/settingsStylesSurface.ts',
  ...
  },
  {
    id: 'final',
    layer: 'D',
    module: 'src/app/settingsStylesFinal.ts',
...
export const SETTINGS_STYLE_IMPORT_ORDER = SETTINGS_STYLE_BUNDLES.flatMap((bundle) => bundle.cssImports)
