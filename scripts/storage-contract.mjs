...
export const STORAGE_KEY_CONTRACTS = [
  ...
  { constant: 'MEMORY_LOCAL_DATA_AUTHORITY_CONSENT_KEY', key: 'nexus:memory:local-data-authority-consent', domain: 'memory', classification: 'settings', authority: 'renderer-localStorage-hidden-feature-consent', migration: 'keep-until-memory-authority-cutover' },
  { constant: 'COMPANION_LOCAL_DATA_AUTHORITY_CONSENT_KEY', key: 'nexus:companion:local-data-authority-consent', domain: 'companion-rhythm', classification: 'settings', authority: 'renderer-localStorage-hidden-feature-consent', migration: 'keep-until-companion-authority-cutover' },
  ...
  { constant: 'COMPANION_CHECK_IN_DECISION_STORAGE_KEY', key: 'nexus:companion-awareness:recent-check-in-decision', domain: 'companion-awareness', classification: 'ephemeral', authority: 'renderer-localStorage', migration: 'do-not-migrate' },
  { constant: 'COMPANION_SUMMARY_SESSION_KEY', key: 'nexus:companion-awareness:session-id', domain: 'companion-awareness', classification: 'session', authority: 'renderer-sessionStorage', migration: 'do-not-migrate' },
  ...
  { constant: 'CHAT_LOCAL_DATA_AUTHORITY_CONSENT_KEY', key: 'nexus:chat:local-data-authority-consent', domain: 'chat', classification: 'settings', authority: 'renderer-localStorage-hidden-feature-consent', migration: 'keep-until-chat-authority-cutover' },
