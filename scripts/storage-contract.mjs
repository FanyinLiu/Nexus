...
export const STORAGE_KEY_CONTRACTS = [
  ...
  { constant: 'STORAGE_KEY', key: 'nexus:vts-auth-token', domain: 'pet', classification: 'secret-adjacent', authority: 'renderer-localStorage-legacy-sensitive', migration: 'migrate-to-main-vault-before-default-vts' },
