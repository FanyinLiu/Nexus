...
## 本次更新 — v0.3.3-beta.1（预发布）

> **维护 + 打磨 + 瘦身。** 导入角色卡可驱动聊天、语音识别云→本地兜底、一批 bug 修复、桌宠默认改名 Pip 并默认显示背景、移除分身、删约 2500 行死代码。完整说明见 [RELEASE-NOTES-v0.3.3-beta.1.md](RELEASE-NOTES-v0.3.3-beta.1.md)（英文）。预发布版仅供手动验证。
