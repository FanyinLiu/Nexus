...
> **Beta 후보:** `v0.4.7-beta.1`에서 Live2D 가져오기 호환성, 복구 안내, 리소스 진단을 검증 중이며 아직 안정 버전이 아닙니다. 자세한 내용은 [후보 릴리스 노트](RELEASE-NOTES-v0.4.7-beta.1.md)(영어).
...
## Beta 미리보기 — v0.4.7-beta.1

> **테마: 아바타 호환성과 진단.** 활성화 전에 Moc, 텍스처, 선언된 리소스를 검사합니다. 모션이나 표정이 없는 모델은 표시를 유지하며 상호작용 제한을 안내하고, 세 모델 전환 보고서에 리소스 개수를 남깁니다. 안정 버전은 v0.4.5입니다.
