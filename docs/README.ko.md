...
> **현재 릴리스:** v0.3.4 안정 버전. Nexus는 지금도 일상적으로 사용할 수 있지만, 빠르게 다듬고 있는 개인 프로젝트입니다. 패키징, 선택형 로컬 음성 모델, provider 설정에는 아직 약간의 수동 처리가 필요한 부분이 남아 있을 수 있습니다.
...
> **v0.3.4 beta 라인을 안정 버전으로 승격했습니다.** 그녀의 작은 표정이 채팅 텍스트가 아니라 얼굴에 닿습니다. 자세한 내용은 [RELEASE-NOTES-v0.3.4.md](RELEASE-NOTES-v0.3.4.md)(영어).
