...
## 本次更新 — v0.3.3-beta.1（預發布）

> **維護 + 打磨 + 瘦身。** 匯入角色卡可驅動聊天、語音識別雲→本地備援、一批 bug 修復、桌寵預設改名 Pip 並預設顯示背景、移除分身、刪約 2500 行死碼。完整說明見 [RELEASE-NOTES-v0.3.3-beta.1.md](RELEASE-NOTES-v0.3.3-beta.1.md)（英文）。預發布版僅供手動驗證。
