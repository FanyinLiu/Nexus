...
test('v0.4 desktop companion awareness hardening stays documented', () => {
  ...
  assert.match(v04Plan, /current active stacked v0\.4\.x slice is `v0\.4\.3`\s+User-Facing Transparency/)
  assert.match(v04Plan, /Do not expand `v0\.4\.3` into external notifications/)
