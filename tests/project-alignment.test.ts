...
test('v0.4 desktop companion awareness hardening stays documented', () => {
  ...
  assert.match(v04Plan, /current active stacked\s+v0\.4\.x slice is `v0\.4\.2` Check-In Policy/)
  assert.match(v04Plan, /Do not expand `v0\.4\.2` into external notifications/)
  ...
  assert.match(v04Plan, /Future candidate after v0\.4\.0 stable: v0\.4\.3/)
